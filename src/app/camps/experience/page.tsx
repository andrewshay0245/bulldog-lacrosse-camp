...
export const metadata = {
  ...
  description: 'Yale-specific prospect day for high school players. Immersive training with coaches from Yale, NESCAC, and D1 programs.',
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-700 mb-6">
                The Bulldog Experience is a Yale-specific prospect day offering high school players
                an immersive training environment. This is a recruiting-focused event designed for
                players interested in Yale lacrosse.
              </p>
              <p className="text-gray-700 mb-6">
                Coaches from Yale, NESCAC schools, and area Division I programs attend to evaluate
                talent. Players experience what it&apos;s like to train at a top Division I program
                while showcasing their abilities.
              </p>
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start">
                  ...
                  <span>Immersive training experience</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
