    ...
    <nav className="bg-[#00356b] text-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            >
              ...
              {prospectsDropdown && (
                <div className="absolute top-full left-0 bg-white text-gray-800 rounded-lg shadow-lg py-2 min-w-56">
                  <Link href="/camps/bulldog-120" className="block px-4 py-2 hover:bg-gray-100">Bulldog 120</Link>
                  <Link href="/camps/experience" className="block px-4 py-2 hover:bg-gray-100">Bulldog Experience</Link>
            ...
            <div
              className="relative"
              onMouseEnter={() => setTournamentsDropdown(true)}
              onMouseLeave={() => setTournamentsDropdown(false)}
            >
              <button className="hover:text-gray-300 transition flex items-center">
                Tournaments
                <svg className="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#00356b] border-t border-blue-800 px-4 py-4 space-y-3">
          ...
          <div className="border-t border-blue-800 pt-2">
            <p className="text-gray-300 text-sm mb-2">Tournaments</p>
